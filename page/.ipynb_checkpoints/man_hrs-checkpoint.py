...
def show():
    ...
    excel_file = pd.ExcelFile('data/Man-Hrs.xlsx')
    states = ['BH', 'WB', 'JH', 'OR','NE','EAST', 'MH-1', 'MH-2', 'GJS', 'GJN', 'MP','WEST', 'UPE', 'UPW', 'PB/HP', 'DL/HR','RJ','NORTH', 'AP/TL', 'KR', 'KL', 'TN','SOUTH']
    value_types = ['Actual']
    ...
    for state in states:
        ...
        if actual_col in data_raw.columns:
